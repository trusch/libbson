...
TEST(BSON,JsonPrimitiveTest){
	...
	//EXPECT_TRUE(integer_32bit == integer_32bit_copy);// json integers are converted to int64
	//EXPECT_TRUE(date == date_copy);// date is not a supported json type. backconversion ends up in a int64
}
